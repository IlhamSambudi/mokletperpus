...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            <a class="nav-item nav-link" href="tampilanggota.php"><i class="fa fa-book"></i> Home</a>
            ...
            <a class="nav-item nav-link" href="anggota.php"><i class="fa fa-user-graduate"></i> <?php echo $_SESSION['username']; ?></a>
